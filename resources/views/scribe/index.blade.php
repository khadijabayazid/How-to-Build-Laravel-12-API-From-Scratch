...
<div class="tocify-wrapper">
            <img src="https://demo-eshop-bootstrap.filamentexamples.com/storage/logo.png" alt="logo" class="logo" style="padding-top: 10px;" width="100%"/>
                ...
                <li class="tocify-item level-1" data-unique="categories">
                    <a href="#categories">Categories </a>
                                    ...
                                    <ul id="tocify-subheader-categories" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="categories-GETapi-lists-categories">
                                <a href="#categories-GETapi-lists-categories">GET api/lists/categories</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-GETapi-categories">
                                <a href="#categories-GETapi-categories">Get Categories</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-POSTapi-categories">
                                <a href="#categories-POSTapi-categories">Post categories</a>
                            </li>
...
<p>This API is not authenticated.</p>
    ...
    <p>Managing Categories</p>
                                ...
                                <h2 id="categories-GETapi-lists-categories">GET api/lists/categories</h2>
...
<span id="example-requests-GETapi-lists-categories">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/lists/categories" \
...
<div class="javascript-example">
    ...
    "http://localhost:8000/api/lists/categories"
);
...
<span id="example-responses-GETapi-lists-categories">
            <blockquote>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        ...
        {
            &quot;id&quot;: 4,
            &quot;name&quot;: &quot;beatae corporis excepturi&quot;
        },
        {
            &quot;id&quot;: 5,
            &quot;name&quot;: &quot;fugit occaecati adipisci&quot;
        },
        {
            &quot;id&quot;: 6,
            &quot;name&quot;: &quot;vel qui vitae&quot;
        ...
        {
            &quot;id&quot;: 7,
            &quot;name&quot;: &quot;quidem beatae est&quot;
        },
        {
            &quot;id&quot;: 8,
            &quot;name&quot;: &quot;totam ut eveniet&quot;
        },
        {
            &quot;id&quot;: 9,
            &quot;name&quot;: &quot;cupiditate vitae illum&quot;
        },
        {
            &quot;id&quot;: 10,
            &quot;name&quot;: &quot;autem corrupti non&quot;
        },
        {
            &quot;id&quot;: 11,
            &quot;name&quot;: &quot;Tech&quot;
...
<span id="execution-results-GETapi-lists-categories" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-lists-categories"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-lists-categories"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-lists-categories" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-lists-categories">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-lists-categories" data-method="GET"
      data-path="api/lists/categories"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-lists-categories', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-lists-categories"
                    onclick="tryItOut('GETapi-lists-categories');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-lists-categories"
                    onclick="cancelTryOut('GETapi-lists-categories');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-lists-categories"
            ...
            <b><code>api/lists/categories</code></b>
        </p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-lists-categories"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-lists-categories"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="categories-GETapi-categories">Get Categories</h2>

<p>
</p>

<p>Getting the list of the categories</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/categories?page=12" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Which page to show. Example: <code>12</code></p>
            </div>
                </form>

                    <h2 id="categories-POSTapi-categories">Post categories</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Name of the category. Example: <code>"Clothing</code></p>
        </div>
        </form>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;category_id&quot;: 8,
            &quot;name&quot;: &quot;exercitationem&quot;,
            &quot;description&quot;: &quot;Consequatur omnis non amet quidem corrupti maxime facilis est. Voluptate fugiat qui veniam reiciendis ratione. Consequatur est asperiores harum dolorem eos quasi sunt nam.&quot;,
            &quot;price&quot;: &quot;167.85&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 8,
                &quot;name&quot;: &quot;totam ut eveniet&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 6,
            &quot;name&quot;: &quot;nemo&quot;,
            &quot;description&quot;: &quot;Sit eligendi cupiditate officia dicta explicabo non. Ut impedit dolor et quo fuga voluptas. Nisi magnam expedita et facilis cupiditate. Facere placeat modi eum eum non.&quot;,
            &quot;price&quot;: &quot;849.90&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 6,
                &quot;name&quot;: &quot;vel qui vitae&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 9,
            &quot;name&quot;: &quot;eius&quot;,
            &quot;description&quot;: &quot;Quia debitis voluptatum consequuntur impedit nihil sit consequatur. Nisi voluptatem maiores error et. Et nulla inventore fugit voluptas laudantium et.&quot;,
            &quot;price&quot;: &quot;236.72&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 9,
                &quot;name&quot;: &quot;cupiditate vitae illum&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 6,
            &quot;name&quot;: &quot;architecto&quot;,
            &quot;description&quot;: &quot;Culpa amet aperiam voluptatem non. Et dolor illum repudiandae quas. Ad in laudantium et nam atque perspiciatis.&quot;,
            &quot;price&quot;: &quot;213.27&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 6,
                &quot;name&quot;: &quot;vel qui vitae&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 10,
            &quot;name&quot;: &quot;quos&quot;,
            &quot;description&quot;: &quot;Eum quasi omnis quod minus maiores aut. Sapiente delectus sequi atque sunt aliquam quibusdam. Tempore earum voluptas voluptatem aut ut.&quot;,
            &quot;price&quot;: &quot;639.53&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 10,
                &quot;name&quot;: &quot;autem corrupti non&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 4,
            &quot;name&quot;: &quot;voluptatem&quot;,
            &quot;description&quot;: &quot;Porro sit et nesciunt libero. Voluptatem aut ut totam. Nam eligendi repellendus labore quis amet totam.&quot;,
            &quot;price&quot;: &quot;806.96&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 4,
                &quot;name&quot;: &quot;beatae corporis excepturi&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 9,
            &quot;name&quot;: &quot;at&quot;,
            &quot;description&quot;: &quot;Nesciunt deleniti cum optio nemo quos necessitatibus ut. Dignissimos officiis saepe magni et culpa minus. Neque corporis iure dolore autem.&quot;,
            &quot;price&quot;: &quot;502.04&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 9,
                &quot;name&quot;: &quot;cupiditate vitae illum&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 8,
            &quot;name&quot;: &quot;fuga&quot;,
            &quot;description&quot;: &quot;Consequatur repellat est inventore odit quia quos nihil. Aut et aut voluptatem et. Dolor sunt error impedit modi dolores veritatis. Nisi molestiae accusantium fuga voluptas quia velit porro.&quot;,
            &quot;price&quot;: &quot;44.06&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 8,
                &quot;name&quot;: &quot;totam ut eveniet&quot;
        ...
        },
        {
            ...
            &quot;category_id&quot;: 1,
            &quot;name&quot;: &quot;sed&quot;,
            &quot;description&quot;: &quot;Nihil est nihil est dolores. Necessitatibus aut cum voluptatem labore enim iste. Aliquid laborum consequuntur qui adipisci quibusdam suscipit. Ea officia incidunt omnis quia. Facere sed doloribus ex nihil.&quot;,
            &quot;price&quot;: &quot;208.97&quot;,
            &quot;category&quot;: {
                &quot;id&quot;: 1,
                &quot;name&quot;: &quot;sint accusamus ut&quot;
